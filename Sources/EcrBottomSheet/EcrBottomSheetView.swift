...
internal struct EcrBottomSheetView<hContent: View, mContent: View, bottomSheetPositionEnum: RawRepresentable>: View where bottomSheetPositionEnum.RawValue == CGFloat, bottomSheetPositionEnum: CaseIterable {
    
    @State private var translation: CGFloat = 0
    @Binding private var bottomSheetPosition: bottomSheetPositionEnum
    
    private let options: [EcrBottomSheet.Options]
    ...
    internal init(bottomSheetPosition: Binding<bottomSheetPositionEnum>, options: [EcrBottomSheet.Options], @ViewBuilder headerContent: () -> hContent?, @ViewBuilder mainContent: () -> mContent) {
...
@available(iOSApplicationExtension, unavailable)
internal extension EcrBottomSheetView where hContent == ModifiedContent<ModifiedContent<Text, _EnvironmentKeyWritingModifier<Optional<Int>>>, _PaddingLayout> {
    init(bottomSheetPosition: Binding<bottomSheetPositionEnum>, options: [EcrBottomSheet.Options], title: String?, @ViewBuilder content: () -> mContent) {
        if title == nil {
