...
#### v1.0.6
- Updated .bottom EcrBottomSheetPosition to mimic Apple Maps

#### v1.0.5
- Made the EcrBottomSheet easier to drag
- Updated .top EcrBottomSheetPosition to mimic Apple Maps
- Search Bar enhancements
- Fixed .bottom EcrBottomSheetPosition #1
